...
const LandingPage = () => {
  ...
  const mobileBg =
    "https://res.cloudinary.com/dficko9l8/image/upload/q_auto,f_auto/Mobile_wcue4b.png";
  const desktopBg =
    "https://res.cloudinary.com/dficko9l8/image/upload/q_auto,f_auto/Desktop_tds6fg.png";
  ...
  return (
    <div className="relative h-[100dvh] overflow-hidden">
      ...
      >
        <h2 className="w-fit font-montserrat absolute bottom-1 left-1/2 -translate-x-1/2 text-md">
          SCROLL DOWN
        </h2>
      </div>

      {/* Bottom ClipPath (Mobile) */}
      <div className="absolute clipP bottom-0 z-[20] right-0 text-white w-full h-full [clip-path:polygon(0%_100%,35%_100%,40%_96%,60%_96%,65%_100%)] block lg:hidden">
        <h2 className="w-fit absolute font-montserrat bottom-4 left-1/2 -translate-x-1/2 text-xs md:text-xl">
          SCROLL DOWN
        </h2>
      </div>

      {/* Mobile Left ClipPath */}
      <div
      ...
      >
        <button
          ...
          className="w-fit absolute top-[50%] -translate-y-1/2 -right-6 md:-right-12 font-semibold text-xs md:text-xl rotate-90"
        >
          BESTSELLER
        </button>
      </div>

      {/* Mobile Top Logo ClipPath */}
      <div
        ...
        style={{
          clipPath: "polygon(0px 0px, 35% 0px, 40% 5%,60% 5%, 65% 0px, 100% 0px)",
        }}
      >
        <Image
          src="/logo.svg"
