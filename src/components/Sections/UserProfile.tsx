  ...
  return (
    <div className="text-white min-h-screen p-4 sm:p-6 md:p-10 lg:p-16 flex flex-col w-full">
      <div className="max-w-7xl mx-auto w-full flex-grow">
        ...
        <div className="absolute w-[80vw] h-[40vw] rounded-full bg-lime-600/10 blur-3xl left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 -z-1"></div>
            ...
            {activeSection === "orders" && (
              <div>
                ...
                {[
                  ...
                  <div
                    key={index}
                    className="flex flex-col sm:flex-row items-center justify-between border-b border-gray-700 py-4 space-y-4 sm:space-y-0 text-center sm:text-left"
                  >
                    ...
                    <div className="flex flex-col sm:flex-row w-full space-y-4 sm:space-y-0 sm:space-x-4 items-center sm:items-start">
                      ...
                      <div className="flex flex-col w-full items-center sm:items-start">
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                          <span
                            className={`text-xs ${order.color} text-black px-2 py-1 rounded-sm`}
                          >
                            {order.status}
                          </span>
