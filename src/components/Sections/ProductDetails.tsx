  ...
  return (
    <>
      {productData ? (
        <>
          <Navigation />
          <div className="w-full mx-auto pt-20 px-10 grid grid-cols-1 lg:grid-cols-2 items-start gap-6 lg:gap-8">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-3">
                <div className="w-full sm:w-auto">
                  ...
                  <div className="mt-4 flex flex-row sm:flex-col gap-4">
                    ...
                    <button
                      className="w-full h-10 border border-[#c2e53a] text-white text-xl font-bold flex items-center justify-center gap-2 rounded-lg"
                      onClick={() =>
                        addToCart({
                          ...productData,
                          quantity: 1,
